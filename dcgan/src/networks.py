...
class Discriminator(nn.Module):
    ...
    """
    def __init__(self, n_layers, img_dim, ngpu, stride=2, padding=1, bias=False, max_mult=8):
        super(Discriminator, self).__init__()
        self.ngpu = ngpu
        operations = list()

        # Input cell here:
        operations += [nn.Conv2d(N_CHANNELS, img_dim, 4, stride=stride, padding=padding, bias=bias),
